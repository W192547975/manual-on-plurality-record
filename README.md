...
- \[0-2\][多重人格手册·参考文献](02.md)（在0-1和1-2之间）
- \[2-4\][多重人格手册·创造型基础](24.md)（在2-2和2-3之间）
- [反馈](feedback.md "feedback.md")

使用的图片内容如下（序列号好像是提取的时候随机生成的，后面估计还要重新搞）：
...
> 目前选用较旧的1.0版是因为只有这版有公共版权许可（我不知道该怎么给这个要授权，看起来有点像扒作者底裤……）。按照惯例建议复制本记录以防*丢失*，但是原文的许可并不规范，所以建议与其他内容分开存储。
